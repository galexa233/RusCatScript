	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.Interact.MouseButton1Click:Connect(function()
				...
				-- Prevents animation from trying to play if the button's callback called RusCatScriptLibrary:Destroy()
				if ruscatscriptDestroyed then
					return
				end
				if not Success then
					...
					print("RusCatScript | "..ButtonSettings.Name.." Callback Error " ..tostring(Response))
					warn('Check documentation for help with RusCatScript specific development.')
					task.wait(0.5)
					Button.Title.Text = ButtonSettings.Name
		...
		function Tab:CreateColorPicker(ColorPickerSettings)
			...
			ColorPicker.Interact.MouseButton1Down:Connect(function()
				...
				if not opened then
					...
					TweenService:Create(Main, TweenInfo.new(0.2, Enum.EasingStyle.Exponential), {ImageTransparency = SelectedTheme ~= RusCatScriptLibrary.Theme.Default and 0.25 or 0.1}):Play()
